...
Описание
Веб-приложение для управления автодилером, позволяющее пользователям создавать аккаунты, просматривать каталог автомобилей, управлять объявлениями об автомобилях и отслеживать историю обслуживания. Система включает REST API для взаимодействия с клиентом, систему аутентификации и управление базой данных автомобилей с параметрами (марка, модель, год, цена, пробег и т.д.).
Технологии
PHP 7.4+
MySQL / MariaDB
HTML, CSS, Bootstrap
